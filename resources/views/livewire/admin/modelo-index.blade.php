            ...
            <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-3 text-sm font-medium flex">
                            <a class="btn bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-2" wire:click="edit({{ $modelo }})" title="Editar Modelo">
                                <i class="fas fa-edit"></i>
                            </a>
                            @if ($modelo->equipos->isEmpty()) 
                            <a class="btn bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded ml-2" wire:click="$emit('deleteUtil', {{ $modelo->id }}, 'modelo')" title="Eliminar Modelo">
    ...
    <x-jet-dialog-modal wire:model="openEdit">
        ...
        <x-slot name="content">
            <div class="mb-4">
                ...
                <x-jet-input wire:model="modelo.nombre" type="text" class="w-full" />
                <x-jet-input-error for="modelo.nombre" />
            </div>
            <div class="mb-4">
